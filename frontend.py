...
label1 = Label(window, text = "Title",bg="powder blue",fg='green',font="Times 15 bold",relief=RAISED,bd=4)
...
# List all data.
listing = Listbox(window, height = 16, width = 35,bg='yellow',fg='red',
                  font="Times 15 bold")
